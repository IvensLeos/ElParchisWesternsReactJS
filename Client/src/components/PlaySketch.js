...
const PlaySketch = () => {
   ...
   let posicionInicialX = [67, 94, 122, 149, 475, 502, 529, 557, 67, 94, 122, 149, 475, 502, 529, 557]
   let posicionInicialY = [140, 140, 140, 140, 140, 140, 140, 140, 501, 501, 501, 501, 501, 501, 501, 501]
   ...
   const draw = p5 => {
      ...
      p5.fill(255)
      p5.text('IVENS LEOS', 107, 26)
      p5.text('IVENS LEOS', 515, 26)
      p5.text('IVENS LEOS', 107, 617)
      p5.text('IVENS LEOS', 515, 617)

      p5.imageMode(p5.CENTER)
      p5.image(ImagenDados[dado[0] - 1], 297, 307, 50, 50)
      p5.image(ImagenDados[dado[1] - 1], 338, 343, 50, 50)
   ...
   return <Sketch setup={setup} draw={draw} preload={preload} className="mx-auto mt-3" />
}
